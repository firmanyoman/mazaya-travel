          ...
          <SectionShell className="px-1">
            ...
            <div className="grid gap-6 lg:grid-cols-2 xl:grid-cols-3">
              {packageList.map((pkg) => {
                ...
                return (
                  <article key={pkg.id} className="group flex h-full flex-col overflow-hidden rounded-[24px] border border-border bg-surface shadow-[var(--shadow-2)] transition-transform duration-150 hover:-translate-y-1">
